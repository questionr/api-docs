...
```shell
curl "https://questionr.com/api/v1/public_settings" \
  -H "Authorization: Questionr secret_id secret"
```

```http
GET /api/v1/public_settings HTTP/1.1
...
```shell
curl "https://questionr.com/api/v1/public_settings?ids%5B%5D=711&ids%5B%5D=712" \
  -H "Authorization: Questionr secret_id secret"
```
```http
GET /api/v1/public_settings?ids%5B%5D=711&ids%5B%5D=712 HTTP/1.1
Authorization: Questionr secret_id secret
Accept: application/vnd.questionr.com; version=1,application/json
Host: questionr.com
```
...
```shell
curl "https://questionr.com/api/v1/public_settings/2" \
  -H "Authorization: Questionr secret_id secret"
```

```http
GET /api/v1/public_settings/<ID> HTTP/1.1
Authorization: Questionr secret_id secret
Accept: application/vnd.questionr.com; version=1,application/json
Host: questionr.com
```
...
```http
POST /api/v1/public_settings HTTP/1.1
Authorization: Questionr secret_id secret
Accept: application/vnd.questionr.com; version=1,application/json
Host: questionr.com
```
...
```
```http
PATCH /api/v1/public_settings/<ID> HTTP/1.1
Authorization: Questionr secret_id secret
Accept: application/vnd.questionr.com; version=1,application/json
Host: questionr.com
```
...
```http
DELETE /api/v1/public_settings/<ID> HTTP/1.1
Authorization: Questionr secret_id secret
Accept: application/vnd.questionr.com; version=1,application/json
Host: questionr.com
```
